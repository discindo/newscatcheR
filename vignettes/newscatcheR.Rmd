...
The _newscatcheR_ package provides three simple functions for reading RSS feeds from news outlets and have them conviniently returned as a tibble.
...
The function `tld_sources` is a helper funcion for browsing news sites by top level domains. It's useful to see which newssites from a country are present in the database. 
